...
#    print('***********')
    ...
    with io.open(home + surgePath + '/SSRJson' + '/' +  remarks.replace('*', '#') + '.json', 'w', encoding='utf8') as f:
    # if not os.path.exists(surgePath + '/SSRJson'):
    #     os.makedirs(surgePath + '/SSRJson')
    # with open(surgePath + '/SSRJson' + '/' + remarks.replace('*', '') + '.json', 'w', encoding='utf8') as f:
